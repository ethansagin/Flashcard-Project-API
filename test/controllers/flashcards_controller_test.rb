...
class FlashcardsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create flashcard" do
    assert_difference('Flashcard.count') do
      post flashcards_url, params: { flashcard: { back: @flashcard.back, front: @flashcard.front } }, as: :json
    end
  ...
  test "should update flashcard" do
    patch flashcard_url(@flashcard), params: { flashcard: { back: @flashcard.back, front: @flashcard.front } }, as: :json
    assert_response 200
  end
